...
var BLUEPRINT_CODE_NOTICE = {
  en: `This Script is automatically generated by Blueprint deployment, please do not modify`,
  jp: `このコードはブループリントによって自動的に生成されるため、編集しないでください！`,
  'zh-CN': `本代码由蓝图部署自动生成，请勿手工修改`,
  'zh-HK': `本代碼由藍圖部署自動生成，請勿手工修改`,
  'zh-TW': `本程式碼由藍圖部署自動生成，請勿手工修改`,
};
...
exports.deploy = function(req, res, next) {
  ...
  async.series([
    ...
    // Create Script
    function(asyncCallback) {
      var uiLocale = res.locals.clientUILocale;
      var blueprintCode = generateBlueprintCode(blueprint, uiLocale);
      var _data = {
...
function _genNoticeComment(blueprint, uiLocale) {
  var codeBlock = toolkit.createStringBuilder();
  codeBlock.append(`# ${BLUEPRINT_CODE_NOTICE[uiLocale] || BLUEPRINT_CODE_NOTICE.en}`);
...
function _genRunFunc(blueprint) {
  ...
  // Continuously calling Funcs according to the calling map
  codeBlock.append(`
    data = data or {}
...
function generateBlueprintCode(blueprint, uiLocale) {
  var code = [
    _genNoticeComment(blueprint, uiLocale),

...
Please select sign in method: ログイン方法を選択してください
System built-in user        : システムビルトインユーザ
Username                    : ユーザ名
Password                    : パスワード
Captcha                     : チャレンジ
Sign In                     : ログイン

Please input username             : ユーザ名を入力してください
Please input password             : パスワードを入力してください
Please input captcha              : チャレンジを入力してください
Captcha should be a 4-digit number: チャレンジは4桁の数字

Invalid username or password                                                                 : ユーザ名またはパスワードが正しくない
Invalid captcha                                                                              : チャレンジが正しくない
User has been disabled                                                                       : このユーザは今使用禁止されている
Too many bad passwords, please try again later                                               : パスワードの間違いが多すぎます。後でもう一度やり直してください
retryMinutes                                                                                 : '{n} 分後にもう一度試してください'
Worker no response, please check the status of this system                                   : ワーカーが応答なし、システムステータスをチェックしてください
Integration sign-in func returned an unexpected value, please contact admin                  : 連携ログイン機能が予期しない結果を返したため、システム管理者に連絡してください
Sign in failed. Error occured in integration sign-in func, please concat admin               : ログイン失敗。連携ログイン関数は異常発生したため、システム管理者に連絡してください
Sign in failed. Integration sign-in func timeout, please concat admin                        : ログイン失敗。連携ログイン関数はタイムアウトしたため、システム管理者に連絡してください
Sign in failed. Integration sign-in func returned `False` or empty value, please concat admin: ログイン失敗。連携ログイン関数は`False`または空白を返したため、システム管理者に連絡してください
</i18n>

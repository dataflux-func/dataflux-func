...
res = datakit.write_metric(measurement='some_measurement', tags=tags, fields=fields)`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-datakit/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
...
res = dataway.write_metric(measurement='some_measurement', tags=tags, fields=fields)`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-dataway/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
...
res = sidecar.shell('ls -l', workdir='/home', wait=True)`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-sidecar/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
...
res = influxdb.query('SELECT * FROM "some_measurement" LIMIT 10')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-influxdb/'),
...
res = mysql.query('SELECT * FROM \`some_table\` LIMIT 10')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-mysql/'),
...
res = redis.query('GET', 'some_key')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-redis/'),
...
res = memcached.query('GET', 'some_key')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-memcached/'),
...
res = clickhouse.query('SELECT * FROM some_table LIMIT 10')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-clickhouse/'),
...
res = oracle.query('SELECT * FROM SOME_TABLE WHERE ROWNUM <= 10')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-oracle/'),
...
res = sqlserver.query('SELECT TOP 10 * FROM some_table')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-sqlserver/'),
...
res = postgresql.query('SELECT * FROM some_table LIMIT 10')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-postgresql/'),
...
data = collection.find_one()`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-mongodb/'),
...
res = elasticsearch.query('GET', '/_search', query=query)`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-es/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
...
nsq.publish(topic='some_topic', message='some_message')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-nsq/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
...
mqtt.publish(topic='some_topic',  message='some_message')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-mqtt/'),
...
kafka.publish(topic='some_topic', message='some_message')`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-kafka/'),
...
res = prometheus.query('GET', '/api/v1/query_range', query=query)`,
        ...
        links: {
          doc : T.getOfficialDocURL('/doc/development-guide-builtin-features-dff-conn-prometheus/'),
          http: 'https://pypi.org/project/requests/2.28.1/',
        },
      },
      {
    ...
    return [
      {
        ...
        name              : 'English',
        shortName         : 'EN',
        officialSite      : 'https://dataflux-func.com/',
        officialDocBaseURL: 'https://docs.dataflux-func.com/doc.en',
      },
      {
        key               : 'zh-CN',
        name              : '简体中文',
        shortName         : '简',
        officialSite      : 'https://func.guance.com/',
        officialDocBaseURL: 'https://func.guance.com/doc',
      },
      {
        key               : 'zh-HK',
        name              : '繁體中文（香港）',
        ...
        tip               : 'By OpenCC',
        officialSite      : 'https://dataflux-func.com/',
        officialDocBaseURL: 'https://docs.dataflux-func.com/doc.zh-HK',
      },
      {
        key               : 'zh-TW',
        name              : '繁體中文（臺灣）',
        ...
        tip               : 'By OpenCC',
        officialSite      : 'https://dataflux-func.com/',
        officialDocBaseURL: 'https://docs.dataflux-func.com/doc.zh-TW',
      },
      {
        key               : 'ja',
        name              : '日本語',

...
<template>
  <div id="quickViewWindow"
    ...
    <div @mousedown="startDrag" class="quick-view-header">
      ...
      <el-link :underline="false" class="quick-view-close" @mousedown.native.stop @click.stop="hideWindow()"><i class="fa fa-times"></i> {{ $t('Close') }}</el-link>
    </div>
...
export default {
  ...
  methods: {
    async showWindow(scriptId) {
      let apiRes = await this.T.callAPI_getOne('/api/v1/scripts/do/list', scriptId, {

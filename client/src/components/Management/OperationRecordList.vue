...
All recent important operations will be collected by the system and shown here: 所有近期重要的操作会被系统搜集并展示在此
</i18n>

<!-- Generated by OpenCC START -->
<i18n locale="zh-HK" lang="yaml">
All recent important operations will be collected by the system and shown here: 所有近期重要的操作會被系統蒐集並展示在此
Cost: 耗時
DELETE: 刪除操作
Data ID: 數據 ID
IP Address: IP 地址

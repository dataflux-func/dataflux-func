          ...
          <el-table-column :label="$t('Config')" width="255">
            <template slot-scope="scope">
              ...
              <template v-if="scope.row.isPaused">
                <el-tooltip effect="dark" :content="$t('expireAt', { t: T.getDateTimeString(scope.row.pauseExpireTime * 1000) })" placement="right" :disabled="!!!scope.row.pauseExpireTime">
              ...
              <template v-else-if="scope.row.dynamicCronExpr">
                ...
                <el-tooltip effect="dark" :content="$t('expireAt', { t: T.getDateTimeString(scope.row.dynamicCronExprExpireTime * 1000) })" placement="right" :disabled="!!!scope.row.dynamicCronExprExpireTime">

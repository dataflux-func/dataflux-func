...
# The latest version of this script will be provided, do not modify this script in your own project!
function do_cd(){
  clusterID=$1
  imageFullName=$2
  namespace=$3
...
function do_trigger_tag(){
  ...
  # Create a deploy tag at the latest release tag to trigger the CD action
